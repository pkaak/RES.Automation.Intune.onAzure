...
<#
 # Template for connection to Intune Management on Azure
 # RES ONE Automation integration with Intune

 # Based on scripts at https://github.com/microsoftgraph/powershell-intune-samples
...
####################################################
# Start script. Please edit variable user and location of the passwordfile
#
# region Authentication

$User = "pkaak@pkaak.onmicrosoft.com"
$Password = "C:\intune\Intunecredentials.txt"
    ...
    $TokenExpires = ($authToken.ExpiresOn.datetime - $DateTime).Minutes
        ...
        # write-host
            ...
            if($User -eq $null -or $User -eq ""){
                Write-Host "Error: no user is set to authenticate, please edit the script"
                exit
            }
...
# RES ONE Automation doing it's stuff
write-host -ForegroundColor Yellow "This is the template script. Your token is:"
$authToken